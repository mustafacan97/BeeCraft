DO $$
    ...
    BEGIN    
        ...
        INSERT INTO notification.email_accounts (id, project_id, email, display_name, type_id, client_id, client_secret, tenant_id, access_token, refresh_token, expire_at, created_at)
        VALUES 
            (email_account_id, project_id, 'mustafa@yeyu.co', 'mustafa@yeyu.co', 4, null, null, null, null, null, null, CURRENT_TIMESTAMP);
